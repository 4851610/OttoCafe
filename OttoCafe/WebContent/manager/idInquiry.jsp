...
<script type="text/javascript">
	function addMaterial() {
		...
		open(
				"../manager/idPop.jsp?cafeUniqueKey=" + cafeUniqueKey.value
						+ "&name=" + name.value + "",
				"confirm",
...
<body>
	<header class="major">
		<br> <br> <strong style="font-size: 25px">아이디 찾기</strong>
	</header>
	...
	<section>
		<form name="idInquiry" action="../manager/idPop.jsp" method="post">
			<select id="cafeUniqueKey" style="width: 500px; margin-bottom: 10px"
				...
				id="managerName" placeholder="이름" required class="text"><br>
			<br> <br> <input type="button" id="아이디 찾기" value="아이디 찾기"
				class="button" style="width: 80px" onclick="addMaterial()">&nbsp;&nbsp;
